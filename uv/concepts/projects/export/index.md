...
For more details on lockfiles and how they're created, see the [project layout](https://jiezhi.github.io/dochub/uv/concepts/projects/layout/index.md) and [locking and syncing](https://jiezhi.github.io/dochub/uv/concepts/projects/sync/index.md) documentation.
...
Support for exporting to CycloneDX is in [preview](https://jiezhi.github.io/dochub/uv/concepts/preview/index.md), and may change in any future release.
...
To learn more about lockfiles and exporting, see the [locking and syncing](https://jiezhi.github.io/dochub/uv/concepts/projects/sync/index.md) documentation and the [command reference](https://jiezhi.github.io/dochub/uv/concepts/reference/cli.md#uv-export).

Or, read on to learn how to [build and publish your project to a package index](https://jiezhi.github.io/dochub/uv/guides/package/index.md).
