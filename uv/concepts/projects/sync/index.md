...
Locking is the process of [resolving](https://jiezhi.github.io/dochub/uv/concepts/resolution/index.md) your project's dependencies into a [lockfile](https://jiezhi.github.io/dochub/uv/concepts/projects/layout/#the-lockfile). Syncing is the process of installing a subset of packages from the lockfile into the [project environment](https://jiezhi.github.io/dochub/uv/concepts/projects/layout/#the-project-environment).
...
If the project does not define a build system, it will not be installed. See the [build systems](https://jiezhi.github.io/dochub/uv/concepts/projects/config/#build-systems) documentation for details.
...
See the [optional dependencies](https://jiezhi.github.io/dochub/uv/concepts/projects/dependencies/#optional-dependencies) documentation for details on how to manage optional dependencies.
...
The `dev` group is special-cased and synced by default. See the [default groups](https://jiezhi.github.io/dochub/uv/concepts/projects/dependencies/#default-groups) documentation for details on changing the defaults.
...
See the [development dependencies](https://jiezhi.github.io/dochub/uv/concepts/projects/dependencies/#development-dependencies) documentation for details on how to manage development dependencies.
...
See the [export guide](https://jiezhi.github.io/dochub/uv/concepts/projects/export/index.md) for comprehensive documentation on all export formats and their use cases.
...
On-sync malware checking is in [preview](https://jiezhi.github.io/dochub/uv/concepts/preview/index.md), and is subject to change until stabilized.
