...
`uv init` can be used to create a new project. See [Creating projects](https://jiezhi.github.io/dochub/uv/concepts/projects/init/index.md) for details.
...
- [Python version requirement](https://jiezhi.github.io/dochub/uv/concepts/projects/config/#python-version-requirement)
- [Dependencies](https://jiezhi.github.io/dochub/uv/concepts/projects/dependencies/index.md)
- [Build system](https://jiezhi.github.io/dochub/uv/concepts/projects/config/#build-systems)
- [Entry points (commands)](https://jiezhi.github.io/dochub/uv/concepts/projects/config/#entry-points)
...
With the [`centralized-project-envs` preview feature](https://jiezhi.github.io/dochub/uv/concepts/preview/index.md), uv stores the default project environment in its cache. uv attempts to maintain a `.venv` directory link to the cached environment so existing activation and editor workflows can continue to use the usual path. If link creation fails, uv continues using the cached environment directly, but tools relying on `.venv` may not discover it. Switching interpreters selects separate cached environments and can reuse them later.
...
The lockfile is [automatically created and updated](https://jiezhi.github.io/dochub/uv/concepts/projects/sync/#automatic-lock-and-sync) during uv invocations that use the project environment, i.e., `uv sync` and `uv run`. The lockfile may also be explicitly updated using `uv lock`.
