...
See the dedicated guides for authenticating with specific private index providers: [Azure Artifacts](https://jiezhi.github.io/dochub/uv/guides/integration/azure/index.md), [Google Artifact Registry](https://jiezhi.github.io/dochub/uv/guides/integration/google/index.md), [AWS CodeArtifact](https://jiezhi.github.io/dochub/uv/guides/integration/aws/index.md), and [JFrog Artifactory](https://jiezhi.github.io/dochub/uv/guides/integration/jfrog/index.md).
...
In addition to providing credentials directly, uv supports discovery of credentials from netrc and keyring. See the [HTTP authentication](https://jiezhi.github.io/dochub/uv/concepts/authentication/http/index.md) documentation for details on setting up specific credential providers.
...
If you're using [`exclude-newer`](https://jiezhi.github.io/dochub/uv/concepts/resolution/#reproducible-resolutions), you can configure a different cutoff for a specific index:
