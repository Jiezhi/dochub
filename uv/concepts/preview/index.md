...
- `python-install-default`: Allows [installing `python` and `python3` executables](https://jiezhi.github.io/dochub/uv/concepts/python-versions/#installing-python-executables).
...
- `native-auth`: Enables storage of credentials in a [system-native location](https://jiezhi.github.io/dochub/uv/concepts/authentication/http/#the-uv-credentials-store).
