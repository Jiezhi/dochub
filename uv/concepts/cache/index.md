...
By default, cache cleanup estimates the disk space reclaimed. Enable the `cache-physical-space` [preview feature](https://jiezhi.github.io/dochub/uv/concepts/preview/index.md) for a more accurate estimate that accounts for hardlinks and copy-on-write clones:
