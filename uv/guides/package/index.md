...
We strongly recommend configuring a build system. Read more about build systems in the [project configuration](https://jiezhi.github.io/dochub/uv/concepts/projects/config/#build-systems) documentation.
...
The `uv version` command provides conveniences for updating the version of your package before you publish it. [See the project docs for reading your package's version](https://jiezhi.github.io/dochub/uv/guides/projects/#viewing-your-version).
...
A complete guide to publishing from GitHub Actions to PyPI can be found in the [GitHub Guide](https://jiezhi.github.io/dochub/uv/guides/integration/github/#publishing-to-pypi)
...
Or, read on for [guides](https://jiezhi.github.io/dochub/uv/guides/integration/index.md) on integrating uv with other software.
