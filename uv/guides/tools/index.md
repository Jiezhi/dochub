...
If you are running a tool in a [*project*](https://jiezhi.github.io/dochub/uv/concepts/projects/index.md) and the tool requires that your project is installed, e.g., when using `pytest` or `mypy`, you'll want to use [`uv run`](https://jiezhi.github.io/dochub/uv/guides/projects/#running-commands) instead of `uvx`. Otherwise, the tool will be run in a virtual environment that is isolated from your project.
...
For more details on requesting Python versions, see the [Python version](https://jiezhi.github.io/dochub/uv/concepts/python-versions/#requesting-a-version) concept page.
...
To learn more about managing tools with uv, see the [Tools concept](https://jiezhi.github.io/dochub/uv/concepts/tools/index.md) page and the [command reference](https://jiezhi.github.io/dochub/uv/guides/reference/cli.md#uv-tool).

Or, read on to learn how to [work on projects](https://jiezhi.github.io/dochub/uv/guides/projects/index.md).
