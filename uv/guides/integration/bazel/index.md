...
Then, configure Bazel to invoke [`uv auth helper`](https://jiezhi.github.io/dochub/uv/concepts/authentication/cli/#using-credentials-with-external-tools) for matching hosts:
