...
Astral provides [Docker images](https://jiezhi.github.io/dochub/uv/guides/integration/docker/#available-images) with uv preinstalled. Select a variant that is suitable for your workflow.
...
Using `uv cache prune --ci` at the end of the job is recommended to reduce cache size. See the [uv cache documentation](https://jiezhi.github.io/dochub/uv/concepts/cache/#caching-in-continuous-integration) for more details.
