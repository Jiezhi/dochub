...
Because marimo notebooks are stored as Python scripts, they can encapsulate their own dependencies using inline script metadata, via uv's [support for scripts](https://jiezhi.github.io/dochub/uv/guides/scripts/index.md). For example, to add `numpy` as a dependency to your notebook, use this command:
...
If you're working within a [project](https://jiezhi.github.io/dochub/uv/concepts/projects/index.md), you can start a marimo notebook with access to the project's virtual environment via the following command (assuming marimo is a project dependency):
...
To run marimo in a virtual environment that isn't associated with a [project](https://jiezhi.github.io/dochub/uv/concepts/projects/index.md), add marimo to the environment directly:
