...
If you also want to publish your own packages to AWS CodeArtifact, you can use `uv publish` as described in the [Building and publishing guide](https://jiezhi.github.io/dochub/uv/guides/package/index.md).
