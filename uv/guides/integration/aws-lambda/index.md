...
We'll follow the principles outlined in the [Docker guide](https://jiezhi.github.io/dochub/uv/guides/integration/docker/index.md) (in particular, a multi-stage build) to ensure that the final image is as small and cache-friendly as possible.
...
If a project includes local dependencies (e.g., via [Workspaces](https://jiezhi.github.io/dochub/uv/concepts/projects/workspaces/index.md)), those too must be included in the deployment package.
