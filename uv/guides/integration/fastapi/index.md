...
This creates a [project with an application layout](https://jiezhi.github.io/dochub/uv/concepts/projects/init/#applications) and a `pyproject.toml` file.
...
For more on using uv with Docker, see the [Docker guide](https://jiezhi.github.io/dochub/uv/guides/integration/docker/index.md).
