...
If you're working within a [project](https://jiezhi.github.io/dochub/uv/concepts/projects/index.md), you can start a Jupyter server with access to the project's virtual environment via the following:
...
If you need to run Jupyter in a virtual environment that isn't associated with a [project](https://jiezhi.github.io/dochub/uv/concepts/projects/index.md) (e.g., has no `pyproject.toml` or `uv.lock`), you can do so by adding Jupyter to the environment directly. For example:
