...
The [`tool.uv.keyring-provider`](https://jiezhi.github.io/dochub/uv/guides/reference/settings.md#keyring-provider) setting can be used to enable keyring in your `uv.toml` or `pyproject.toml`.

Similarly, the username for the index can be added directly to the index URL.

## [Publishing packages](#publishing-packages)

If you also want to publish your own packages to Google Artifact Registry, you can use `uv publish` as described in the [Building and publishing guide](https://jiezhi.github.io/dochub/uv/guides/package/index.md).
