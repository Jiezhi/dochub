...
Python does not publish official distributable binaries. As such, uv uses distributions from the Astral [`python-build-standalone`](https://github.com/astral-sh/python-build-standalone) project. See the [Python distributions](https://jiezhi.github.io/dochub/uv/concepts/python-versions/#managed-python-distributions) documentation for more details.
...
See the documentation on [installing Python executables](https://jiezhi.github.io/dochub/uv/concepts/python-versions/#installing-python-executables) for more details.
...
See the [`python install`](https://jiezhi.github.io/dochub/uv/concepts/python-versions/#installing-a-python-version) documentation for more details.
...
See the [`python list`](https://jiezhi.github.io/dochub/uv/concepts/python-versions/#viewing-available-python-versions) documentation for more details.
...
Automatic Python downloads can be [easily disabled](https://jiezhi.github.io/dochub/uv/concepts/python-versions/#disabling-automatic-python-downloads) if you want more control over when Python is downloaded.

## [Using existing Python versions](#using-existing-python-versions)

uv will use existing Python installations if present on your system. There is no configuration necessary for this behavior: uv will use the system Python if it satisfies the requirements of the command invocation. See the [Python discovery](https://jiezhi.github.io/dochub/uv/concepts/python-versions/#discovery-of-python-versions) documentation for details.

To force uv to use the system Python, provide the `--no-managed-python` flag. See the [Python version preference](https://jiezhi.github.io/dochub/uv/concepts/python-versions/#requiring-or-disabling-managed-python-versions) documentation for more details.
...
See the [`python upgrade`](https://jiezhi.github.io/dochub/uv/concepts/python-versions/#upgrading-python-versions) documentation for more details.

## [Next steps](#next-steps)

To learn more about `uv python`, see the [Python version concept](https://jiezhi.github.io/dochub/uv/concepts/python-versions/index.md) page and the [command reference](https://jiezhi.github.io/dochub/uv/guides/reference/cli.md#uv-python).

Or, read on to learn how to [run scripts](https://jiezhi.github.io/dochub/uv/guides/scripts/index.md) and invoke Python with uv.
