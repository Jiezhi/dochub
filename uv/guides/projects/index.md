...
You'll also use this file to specify uv [configuration options](https://jiezhi.github.io/dochub/uv/concepts/configuration-files/index.md) in a [`[tool.uv]`](https://jiezhi.github.io/dochub/uv/guides/reference/settings.md) section.
...
See the [project environment](https://jiezhi.github.io/dochub/uv/concepts/projects/layout/#the-project-environment) documentation for more details.
...
See the [lockfile](https://jiezhi.github.io/dochub/uv/concepts/projects/layout/#the-lockfile) documentation for more details.
...
See the documentation on [managing dependencies](https://jiezhi.github.io/dochub/uv/concepts/projects/dependencies/index.md) for more details.
...
See the [publishing guide](https://jiezhi.github.io/dochub/uv/guides/package/#updating-your-version) for details on updating your package version.
...
`uv run` does not remove extraneous packages (those not in the lockfile) from the environment by default. See [handling of extraneous packages](https://jiezhi.github.io/dochub/uv/concepts/projects/sync/#handling-of-extraneous-packages) for details.
...
See the documentation on [running commands and scripts](https://jiezhi.github.io/dochub/uv/concepts/projects/run/index.md) in projects for more details.
...
See the documentation on [building projects](https://jiezhi.github.io/dochub/uv/concepts/projects/build/index.md) for more details.

## [Next steps](#next-steps)

To learn more about working on projects with uv, see the [projects concept](https://jiezhi.github.io/dochub/uv/concepts/projects/index.md) page and the [command reference](https://jiezhi.github.io/dochub/uv/guides/reference/cli.md#uv).

Or, read on to learn how to [export a uv lockfile to different formats](https://jiezhi.github.io/dochub/uv/concepts/projects/export/index.md).
