...
When using inline script metadata, even if `uv run` is [used in a *project*](https://jiezhi.github.io/dochub/uv/concepts/projects/run/index.md), the project's dependencies will be ignored. The `--no-project` flag is not required.
...
`uv run` will search for and use the required Python version. The Python version will download if it is not installed — see the documentation on [Python versions](https://jiezhi.github.io/dochub/uv/concepts/python-versions/index.md) for more details.
...
If you wish to use an alternative [package index](https://jiezhi.github.io/dochub/uv/concepts/indexes/index.md) to resolve dependencies, you can provide the index with the `--index` option:
...
If you require authentication to access the package index, then please refer to the [package index](https://jiezhi.github.io/dochub/uv/concepts/indexes/index.md) documentation.
...
See the [Python version request](https://jiezhi.github.io/dochub/uv/concepts/python-versions/#requesting-a-version) documentation for more details on requesting Python versions.
...
To learn more about `uv run`, see the [command reference](https://jiezhi.github.io/dochub/uv/guides/reference/cli.md#uv-run).

Or, read on to learn how to [run and install tools](https://jiezhi.github.io/dochub/uv/guides/tools/index.md) with uv.
