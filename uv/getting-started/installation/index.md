...
See the reference documentation on the [installer](https://jiezhi.github.io/dochub/uv/reference/installer/index.md) for details on customizing your uv installation.
...
See our guide on [using uv in Docker](https://jiezhi.github.io/dochub/uv/guides/integration/docker/index.md) for more details.
...
1. Clean up stored data (optional):
   ...
   Before removing the binaries, you may want to remove any data that uv has stored. See the [storage reference](https://jiezhi.github.io/dochub/uv/reference/storage/index.md) for details on where uv stores data.
...
See the [first steps](https://jiezhi.github.io/dochub/uv/getting-started/first-steps/index.md) or jump straight to the [guides](https://jiezhi.github.io/dochub/uv/guides/index.md) to start using uv.
