...
See the [Git authentication](https://jiezhi.github.io/dochub/uv/concepts/authentication/git/index.md) documentation for installation from a private repository.
...
See the [`uv pip compile`](https://jiezhi.github.io/dochub/uv/pip/compile/index.md) documentation for more information on `requirements.txt` files.
