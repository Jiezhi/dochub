...
function getHeadings() {
  return [{
    ...
    "depth": 2,
    "slug": "ตัวแปรสภาพแวดล้อม",
    "text": "ตัวแปรสภาพแวดล้อม"
  }, {
    "depth": 3,
    "slug": "ขั้นทดลอง",
    "text": "ขั้นทดลอง"
...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(Fragment$1, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-c</code></td><td>ดำเนินการต่อจากเซสชันล่าสุด</td>"
          })]
          ...
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-s</code></td><td>ID เซสชันเพื่อดำเนินการต่อ</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>แยกเซสชันเมื่อทำต่อ (ใช้กับ <code dir=\"auto\">--continue</code> หรือ <code dir=\"auto\">--session</code>)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>พรอมต์เริ่มต้นที่จะใช้</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td><code dir=\"auto\">-m</code></td><td>โมเดลที่จะใช้ในรูปแบบ provider/model</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>เอเจนต์ที่จะใช้</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>พอร์ตที่จะฟัง</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td></td><td>ไดเร็กทอรีการทำงานเพื่อเริ่มต้น TUI ใน</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
          ...
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td></td><td>แยกเซสชันเมื่อดำเนินการต่อ (ใช้กับ <code dir=\"auto\">--continue</code> หรือ <code dir=\"auto\">--session</code>)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td><code dir=\"auto\">-p</code></td><td>รหัสผ่านการยืนยันตัวตนพื้นฐาน (ค่าเริ่มต้นคือ <code dir=\"auto\">OPENCODE_SERVER_PASSWORD</code>)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "เหตุการณ์ GitHub เพื่อทริกเกอร์เอเจนต์"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "รีเฟรชแคชโมเดลจาก models.dev"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "แสดงรายละเอียดโมเดลเพิ่มเติม (รวมข้อมูลเมตาเช่นต้นทุน)"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td></td><td>คำสั่งที่จะรัน (ใช้ส่วนที่เหลือของ args เป็นอาร์กิวเมนต์)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
          ...
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td></td><td>สร้างลิงก์แชร์สำหรับเซสชัน</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
          ...
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-f</code></td><td>แนบไฟล์ไปกับข้อความ</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>รูปแบบเอาต์พุต: text (จัดรูปแบบ) หรือ json (JSON ดิบ)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>ชื่อสำหรับเซสชัน (หากไม่ได้ระบุ จะสร้างจากพรอมต์)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>แนบไปกับเซิร์ฟเวอร์ opencode ที่ทำงานอยู่ (เช่น <a href=\"http://localhost:4096\">http://localhost:4096</a>)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
          ...
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td></td><td>ไดเร็กทอรีสำหรับรัน หรือเส้นทางบนเซิร์ฟเวอร์ระยะไกลเมื่อแนบ</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>ตัวแปรโมเดล (ระดับการใช้เหตุผลเฉพาะผู้ให้บริการ)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>แสดงบล็อกความคิด</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>พอร์ตสำหรับเซิร์ฟเวอร์ภายในเครื่อง (หากไม่ได้ระบุ จะใช้พอร์ตสุ่ม)</td>"
          })]
        })]
      })]
    }), "\n", createVNode(Fragment$1, {
      "set:html": "<hr>\n<h3 id=\"serve\"><a href=\"#serve\">serve</a></h3>\n<p>เริ่มต้นเซิร์ฟเวอร์ OpenCode headless ที่ให้บริการ API HTTP ดู <a href=\"/docs/server\">เอกสารเซิร์ฟเวอร์</a> สำหรับรายละเอียด API เต็มรูปแบบ</p>\n<div class=\"expressive-code\"><figure class=\"frame is-terminal not-content\"><figcaption class=\"header\"><span class=\"title\"></span><span class=\"sr-only\">Terminal window</span></figcaption><pre data-language=\"bash\"><code><div class=\"ec-line\"><div class=\"code\"><span style=\"--0:#6F42C1;--1:#B392F0\">opencode</span><span style=\"--0:#24292E;--1:#E1E4E8\"> </span><span style=\"--0:#032F62;--1:#9ECBFF\">serve</span></div></div></code></pre><div class=\"copy\"><div aria-live=\"polite\"></div><button title=\"Copy to clipboard\" data-copied=\"Copied!\" data-code=\"opencode serve\"><div></div></button></div></figure></div>\n<p>คำสั่งนี้จะเริ่มต้นเซิร์ฟเวอร์ HTTP ให้ API เข้าถึงฟังก์ชันการทำงานของ OpenCode ได้โดยไม่ต้องมี TUI นอกจากนี้ยังรองรับการตรวจสอบสิทธิ์พื้นฐาน HTTP (ชื่อผู้ใช้เริ่มต้นคือ <code dir=\"auto\">opencode</code> และรหัสผ่านระบุโดย <code dir=\"auto\">OPENCODE_SERVER_PASSWORD</code>)</p>\n<h4 id=\"แฟล็ก-5\"><a href=\"#แฟล็ก-5\">แฟล็ก</a></h4>\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n"
    }), createVNode(_components.table, {
      children: [createVNode(_components.thead, {
        children: createVNode(_components.tr, {
          children: [createVNode(_components.th, {
        ...
        children: [createVNode(_components.tr, {
          ...
          children: [createVNode(_components.td, {
            ...
            "set:html": "เปิดใช้งานการค้นหา mDNS"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-n</code></td><td>จำกัดการแสดงผล N รายการล่าสุด</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "แสดงสถิติของ N วันที่ผ่านมา (ค่าเริ่มต้น: ตลอดเวลา)"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "แสดงสถิติการใช้เครื่องมือ"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "แสดงรายละเอียดการใช้งานโมเดล (ซ่อนไว้ตามค่าเริ่มต้น)"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      "set:html": "<hr>\n<h3 id=\"acp\"><a href=\"#acp\">acp</a></h3>\n<p>เริ่มต้นเซิร์ฟเวอร์ ACP (Agent Client Protocol)</p>\n<div class=\"expressive-code\"><figure class=\"frame is-terminal not-content\"><figcaption class=\"header\"><span class=\"title\"></span><span class=\"sr-only\">Terminal window</span></figcaption><pre data-language=\"bash\"><code><div class=\"ec-line\"><div class=\"code\"><span style=\"--0:#6F42C1;--1:#B392F0\">opencode</span><span style=\"--0:#24292E;--1:#E1E4E8\"> </span><span style=\"--0:#032F62;--1:#9ECBFF\">acp</span></div></div></code></pre><div class=\"copy\"><div aria-live=\"polite\"></div><button title=\"Copy to clipboard\" data-copied=\"Copied!\" data-code=\"opencode acp\"><div></div></button></div></figure></div>\n<p>คำสั่งนี้เริ่มต้นเซิร์ฟเวอร์ ACP ที่สื่อสารผ่าน stdin/stdout ด้วย nd-JSON</p>\n<h4 id=\"แฟล็ก-9\"><a href=\"#แฟล็ก-9\">แฟล็ก</a></h4>\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n"
    }), createVNode(_components.table, {
      children: [createVNode(_components.thead, {
        children: createVNode(_components.tr, {
          children: [createVNode(_components.th, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-c</code></td><td>เก็บไฟล์การกำหนดค่าไว้</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td><code dir=\"auto\">-d</code></td><td>เก็บไฟล์ข้อมูล (เซสชันและสแน็ปช็อต)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>แสดงสิ่งที่จะลบออกโดยไม่ต้องทำจริง</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-m</code></td><td>วิธีการติดตั้งที่ใช้ curl, npm, pnpm, bun, brew</td>"
          })]
        })
      })]
    }), "\n", createVNode(Fragment$1, {
      "set:html": "<hr>\n<h2 id=\"แฟล็กระดับโลก\"><a href=\"#แฟล็กระดับโลก\">แฟล็กระดับโลก</a></h2>\n<p>OpenCode CLI ยอมรับแฟล็กสากลต่อไปนี้สำหรับทุกคำสั่ง</p>\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n"
    }), createVNode(_components.table, {
      children: [createVNode(_components.thead, {
        children: createVNode(_components.tr, {
          children: [createVNode(_components.th, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-h</code></td><td>แสดงความช่วยเหลือ</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td><code dir=\"auto\">-v</code></td><td>พิมพ์เวอร์ชัน</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>พิมพ์บันทึกไปยัง stderr</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>ระดับการบันทึก (DEBUG, INFO, WARN, ERROR)</td>"
          })]
        })]
      })]
    }), "\n", createVNode(Fragment$1, {
      "set:html": "<hr>\n<h2 id=\"ตัวแปรสภาพแวดล้อม\"><a href=\"#ตัวแปรสภาพแวดล้อม\">ตัวแปรสภาพแวดล้อม</a></h2>\n<p>OpenCode สามารถกำหนดค่าโดยใช้ตัวแปรสภาพแวดล้อม</p>\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n<table><thead><tr><th>ตัวแปร</th><th>ชนิด</th><th>คำอธิบาย</th></tr></thead><tbody><tr><td><code dir=\"auto\">OPENCODE_AUTO_SHARE</code></td><td>Boolean</td><td>แชร์เซสชันอัตโนมัติเมื่อสร้าง</td></tr><tr><td><code dir=\"auto\">OPENCODE_GIT_BASH_PATH</code></td><td>String</td><td>เส้นทางไปยัง Git Bash บน Windows</td></tr><tr><td><code dir=\"auto\">OPENCODE_CONFIG</code></td><td>String</td><td>เส้นทางไปยังไฟล์การกำหนดค่า</td></tr><tr><td><code dir=\"auto\">OPENCODE_TUI_CONFIG</code></td><td>String</td><td>เส้นทางไปยังไฟล์การกำหนดค่า TUI</td></tr><tr><td><code dir=\"auto\">OPENCODE_CONFIG_DIR</code></td><td>String</td><td>เส้นทางไปยังไดเร็กทอรีการกำหนดค่า</td></tr><tr><td><code dir=\"auto\">OPENCODE_CONFIG_CONTENT</code></td><td>String</td><td>เนื้อหาการกำหนดค่าแบบ inline JSON</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_AUTOUPDATE</code></td><td>Boolean</td><td>ปิดใช้งานการอัปเดตอัตโนมัติ</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_PRUNE</code></td><td>Boolean</td><td>ปิดใช้งานการลบข้อมูลเซสชันเก่า</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_TERMINAL_TITLE</code></td><td>Boolean</td><td>ปิดใช้งานการตั้งชื่อหน้าต่าง terminal</td></tr><tr><td><code dir=\"auto\">OPENCODE_PERMISSION</code></td><td>String</td><td>การกำหนดค่าสิทธิ์แบบ inline JSON</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_DEFAULT_PLUGINS</code></td><td>Boolean</td><td>ปิดใช้งานปลั๊กอินเริ่มต้น</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_LSP_DOWNLOAD</code></td><td>Boolean</td><td>ปิดใช้งานการดาวน์โหลด LSP อัตโนมัติ</td></tr><tr><td><code dir=\"auto\">OPENCODE_ENABLE_EXPERIMENTAL_MODELS</code></td><td>Boolean</td><td>เปิดใช้งานโมเดลทดลอง</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_AUTOCOMPACT</code></td><td>Boolean</td><td>ปิดใช้งานการบีบอัดบริบทอัตโนมัติ</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_CLAUDE_CODE</code></td><td>Boolean</td><td>ปิดใช้งานการนำเข้าจาก <code dir=\"auto\">.claude</code> (prompt + skills)</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_CLAUDE_CODE_PROMPT</code></td><td>Boolean</td><td>ปิดใช้งานการนำเข้า <code dir=\"auto\">~/.claude/CLAUDE.md</code></td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_CLAUDE_CODE_SKILLS</code></td><td>Boolean</td><td>ปิดใช้งานการนำเข้า <code dir=\"auto\">.claude/skills</code></td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_MODELS_FETCH</code></td><td>Boolean</td><td>ปิดใช้งานการดึงรายการโมเดลจากระยะไกล</td></tr><tr><td><code dir=\"auto\">OPENCODE_FAKE_VCS</code></td><td>String</td><td>เปิดใช้งาน VCS จำลองสำหรับการทดสอบ</td></tr><tr><td><code dir=\"auto\">OPENCODE_CLIENT</code></td><td>String</td><td>ตัวระบุไคลเอนต์ (ค่าเริ่มต้นคือ <code dir=\"auto\">cli</code>)</td></tr><tr><td><code dir=\"auto\">OPENCODE_ENABLE_EXA</code></td><td>Boolean</td><td>เปิดใช้งานการใช้ Exa แทน ls หากมี</td></tr><tr><td><code dir=\"auto\">OPENCODE_SERVER_PASSWORD</code></td><td>String</td><td>รหัสผ่านสำหรับการตรวจสอบสิทธิ์พื้นฐาน <code dir=\"auto\">serve</code>/<code dir=\"auto\">web</code></td></tr><tr><td><code dir=\"auto\">OPENCODE_SERVER_USERNAME</code></td><td>String</td><td>ชื่อผู้ใช้สำหรับการตรวจสอบสิทธิ์พื้นฐาน (ค่าเริ่มต้น <code dir=\"auto\">opencode</code>)</td></tr><tr><td><code dir=\"auto\">OPENCODE_MODELS_URL</code></td><td>String</td><td>URL ที่กำหนดเองสำหรับการดึงรายการโมเดล</td></tr></tbody></table>\n<hr>\n<h3 id=\"ขั้นทดลอง\"><a href=\"#ขั้นทดลอง\">ขั้นทดลอง</a></h3>\n<p>ตัวแปรสภาพแวดล้อมเหล่านี้เปิดใช้งานฟีเจอร์ทดลองที่อาจมีการเปลี่ยนแปลงหรือถูกลบออก</p>\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n<table><thead><tr><th>ตัวแปร</th><th>ชนิด</th><th>คำอธิบาย</th></tr></thead><tbody><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL</code></td><td>Boolean</td><td>เปิดใช้งานฟีเจอร์ทดลองทั้งหมด</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_ICON_DISCOVERY</code></td><td>Boolean</td><td>การค้นหาไอคอนทดลอง</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_DISABLE_COPY_ON_SELECT</code></td><td>Boolean</td><td>ปิดใช้งานการคัดลอกเมื่อเลือกใน TUI</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_BASH_DEFAULT_TIMEOUT_MS</code></td><td>Number</td><td>การหมดเวลาเริ่มต้นสำหรับคำสั่ง bash ในหน่วย ms</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_OUTPUT_TOKEN_MAX</code></td><td>Number</td><td>ขีดจำกัดสูงสุดสำหรับโทเค็นเอาต์พุต LLM</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_FILEWATCHER</code></td><td>Boolean</td><td>เปิดใช้งานตัวเฝ้าดูไฟล์สำหรับไดเร็กทอรีทั้งหมด</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_OXFMT</code></td><td>Boolean</td><td>ใช้ oxfmt เป็นตัวจัดรูปแบบ</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_LSP_TOOL</code></td><td>Boolean</td><td>เปิดใช้งานเครื่องมือ LSP ทดลอง</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_DISABLE_FILEWATCHER</code></td><td>Boolean</td><td>ปิดใช้งานตัวเฝ้าดูไฟล์</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_EXA</code></td><td>Boolean</td><td>ฟีเจอร์ Exa ทดลอง</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_LSP_TY</code></td><td>Boolean</td><td>เปิดใช้งาน TY LSP สำหรับไฟล์ python</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_PLAN_MODE</code></td><td>Boolean</td><td>เปิดใช้งาน Plan mode</td></tr></tbody></table>"
    })]
  });
}
...
const url = "src/content/docs/th/cli.mdx";
const file = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/th/cli.mdx";
...
Content.moduleId = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/th/cli.mdx";
