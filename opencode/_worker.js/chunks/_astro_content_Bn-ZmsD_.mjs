...
import { A as AstroError, U as UnknownContentCollectionError, a as createComponent, k as RenderUndefinedEntryError, j as escape, u as unescapeHTML, b as renderTemplate, f as AstroUserError, l as renderUniqueStylesheet, m as renderScriptElement, n as createHeadAndContent, r as renderComponent } from './astro/server_D-7CwiXF.mjs';
import { r as removeBase, i as isRemotePath, p as prependForwardSlash } from './path_CEGCiB5i.mjs';
import { V as VALID_INPUT_FORMATS } from './consts_Q4AsXsmN.mjs';
import { u as unflatten } from './parse_B1Jbr61x.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DdWTwm25.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_D8SVuEtc.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_C2w31nr7.mjs');
