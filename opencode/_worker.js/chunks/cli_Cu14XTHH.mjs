      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-c</code></td><td>最後のセッションを続行</td>"
          })]
          ...
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td></td><td>続行時にセッションをフォーク (<code dir=\"auto\">-s</code> または <code dir=\"auto\">--fork</code> と併用)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
          ...
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-m</code></td><td>プロバイダー/モデルの形式で使用するモデル</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>使用するエージェント</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>リッスンするポート</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td></td><td>TUI を開始する作業ディレクトリ</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
          ...
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-s</code></td><td>続行するセッション ID</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>続行時にセッションをフォーク（<code dir=\"auto\">--continue</code> または <code dir=\"auto\">--session</code> と使用）</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td><code dir=\"auto\">-p</code></td><td>Basic 認証パスワード（デフォルトは <code dir=\"auto\">OPENCODE_SERVER_PASSWORD</code>）</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "エージェントを実行するための GitHub モック イベント"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "models.dev からモデルキャッシュを更新します。"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td></td><td>実行するコマンド。引数には message を使用します。</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
          ...
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td></td><td>続行時にセッションをフォーク (<code dir=\"auto\">--continue</code> または <code dir=\"auto\">--session</code> と併用)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>セッションを共有する</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
          ...
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-f</code></td><td>メッセージに添付するファイル</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>形式: デフォルト (フォーマット済み) または json (生の JSON イベント)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>セッションのタイトル (値が指定されていない場合は、切り詰められたプロンプトが使用されます)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>実行中の opencode サーバー (<a href=\"http://localhost:4096\">http://localhost:4096</a> など) に接続します。</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
          ...
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td></td><td>実行ディレクトリ、またはアタッチ時のリモートサーバー上のパス</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>モデルバリアント（プロバイダー固有の推論レベル）</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>思考ブロックを表示</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>ローカルサーバーのポート (デフォルトはランダムポート)</td>"
          })]
        })]
      })]
    }), "\n", createVNode(Fragment$1, {
      "set:html": "<hr>\n<h3 id=\"serve\"><a href=\"#serve\">serve</a></h3>\n<p>API アクセスのためにヘッドレス OpenCode サーバーを起動します。完全な HTTP インターフェイスについては、<a href=\"/docs/server\">サーバーのドキュメント</a> を確認してください。</p>\n<div class=\"expressive-code\"><figure class=\"frame is-terminal not-content\"><figcaption class=\"header\"><span class=\"title\"></span><span class=\"sr-only\">Terminal window</span></figcaption><pre data-language=\"bash\"><code><div class=\"ec-line\"><div class=\"code\"><span style=\"--0:#6F42C1;--1:#B392F0\">opencode</span><span style=\"--0:#24292E;--1:#E1E4E8\"> </span><span style=\"--0:#032F62;--1:#9ECBFF\">serve</span></div></div></code></pre><div class=\"copy\"><div aria-live=\"polite\"></div><button title=\"Copy to clipboard\" data-copied=\"Copied!\" data-code=\"opencode serve\"><div></div></button></div></figure></div>\n<p>これにより、TUI インターフェイスを使用せずに opencode 機能への API アクセスを提供する HTTP サーバーが起動します。 <code dir=\"auto\">OPENCODE_SERVER_PASSWORD</code> を設定して HTTP 基本認証を有効にします (ユーザー名のデフォルトは <code dir=\"auto\">opencode</code>)。</p>\n<h4 id=\"フラグ-5\"><a href=\"#フラグ-5\">フラグ</a></h4>\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n"
    }), createVNode(_components.table, {
      children: [createVNode(_components.thead, {
        children: createVNode(_components.tr, {
          children: [createVNode(_components.th, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-n</code></td><td>最新のセッションを N 個に制限</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          ...
          children: [createVNode(_components.td, {
            ...
            "set:html": "モデルの使用状況の内訳を表示 (デフォルトでは非表示)。上位 N 件を表示するには数値を渡します"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-c</code></td><td>構成ファイルを保持する</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td><code dir=\"auto\">-d</code></td><td>セッションデータとスナップショットを保持する</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>削除せずに削除される内容を表示する</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-m</code></td><td>使用されたインストール方法。curl, npm, pnpm, bun, brew</td>"
          })]
        })
      })]
    }), "\n", createVNode(Fragment$1, {
      "set:html": "<hr>\n<h2 id=\"グローバルフラグ\"><a href=\"#グローバルフラグ\">グローバルフラグ</a></h2>\n<p>opencode CLI は次のグローバルフラグを受け取ります。</p>\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n"
    }), createVNode(_components.table, {
      children: [createVNode(_components.thead, {
        children: createVNode(_components.tr, {
          children: [createVNode(_components.th, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-h</code></td><td>ヘルプを表示</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td><code dir=\"auto\">-v</code></td><td>バージョン番号を出力</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>ログを標準エラー出力に出力</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>ログレベル (DEBUG、INFO、WARN、ERROR)</td>"
          })]
        })]
      })]
    }), "\n", createVNode(Fragment$1, {
      "set:html": "<hr>\n<h2 id=\"環境変数\"><a href=\"#環境変数\">環境変数</a></h2>\n<p>OpenCode は環境変数を使用して構成できます。</p>\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n<table><thead><tr><th>変数</th><th>タイプ</th><th>説明</th></tr></thead><tbody><tr><td><code dir=\"auto\">OPENCODE_AUTO_SHARE</code></td><td>ブール値</td><td>セッションを自動的に共有する</td></tr><tr><td><code dir=\"auto\">OPENCODE_GIT_BASH_PATH</code></td><td>文字列</td><td>Windows 上で実行可能な Git Bash へのパス</td></tr><tr><td><code dir=\"auto\">OPENCODE_CONFIG</code></td><td>文字列</td><td>構成ファイルへのパス</td></tr><tr><td><code dir=\"auto\">OPENCODE_CONFIG_DIR</code></td><td>文字列</td><td>config ディレクトリへのパス</td></tr><tr><td><code dir=\"auto\">OPENCODE_CONFIG_CONTENT</code></td><td>文字列</td><td>インライン JSON 構成コンテンツ</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_AUTOUPDATE</code></td><td>ブール値</td><td>自動更新チェックを無効にする</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_PRUNE</code></td><td>ブール値</td><td>古いデータのプルーニングを無効にする</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_TERMINAL_TITLE</code></td><td>ブール値</td><td>ターミナルタイトルの自動更新を無効にする</td></tr><tr><td><code dir=\"auto\">OPENCODE_PERMISSION</code></td><td>文字列</td><td>インライン化された json 権限設定</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_DEFAULT_PLUGINS</code></td><td>ブール値</td><td>デフォルトのプラグインを無効にする</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_LSP_DOWNLOAD</code></td><td>ブール値</td><td>LSP サーバーの自動ダウンロードを無効にする</td></tr><tr><td><code dir=\"auto\">OPENCODE_ENABLE_EXPERIMENTAL_MODELS</code></td><td>ブール値</td><td>実験モデルを有効にする</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_AUTOCOMPACT</code></td><td>ブール値</td><td>自動コンテキスト圧縮を無効にする</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_CLAUDE_CODE</code></td><td>ブール値</td><td><code dir=\"auto\">.claude</code> からの読み取りを無効にする (プロンプト + スキル)</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_CLAUDE_CODE_PROMPT</code></td><td>ブール値</td><td><code dir=\"auto\">~/.claude/CLAUDE.md</code> の読み取りを無効にする</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_CLAUDE_CODE_SKILLS</code></td><td>ブール値</td><td><code dir=\"auto\">.claude/skills</code> のロードを無効にする</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_MODELS_FETCH</code></td><td>ブール値</td><td>リモートソースからのモデルの取得を無効にする</td></tr><tr><td><code dir=\"auto\">OPENCODE_FAKE_VCS</code></td><td>文字列</td><td>テスト目的の偽の VCS プロバイダー</td></tr><tr><td><code dir=\"auto\">OPENCODE_CLIENT</code></td><td>文字列</td><td>クライアント識別子 (デフォルトは <code dir=\"auto\">cli</code>)</td></tr><tr><td><code dir=\"auto\">OPENCODE_ENABLE_EXA</code></td><td>ブール値</td><td>Exa Web 検索ツールを有効にする</td></tr><tr><td><code dir=\"auto\">OPENCODE_SERVER_PASSWORD</code></td><td>文字列</td><td><code dir=\"auto\">serve</code>/<code dir=\"auto\">web</code> の基本認証を有効にする</td></tr><tr><td><code dir=\"auto\">OPENCODE_SERVER_USERNAME</code></td><td>文字列</td><td>基本認証ユーザー名 (デフォルト <code dir=\"auto\">opencode</code>) をオーバーライドします。</td></tr><tr><td><code dir=\"auto\">OPENCODE_MODELS_URL</code></td><td>文字列</td><td>モデル設定を取得するためのカスタム URL</td></tr></tbody></table>\n<hr>\n<h3 id=\"実験的\"><a href=\"#実験的\">実験的</a></h3>\n<p>これらの環境変数により、変更または削除される可能性のある実験的な機能が有効になります。</p>\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n<table><thead><tr><th>変数</th><th>タイプ</th><th>説明</th></tr></thead><tbody><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL</code></td><td>ブール値</td><td>すべての実験的機能を有効にする</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_ICON_DISCOVERY</code></td><td>ブール値</td><td>アイコン検出を有効にする</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_DISABLE_COPY_ON_SELECT</code></td><td>ブール値</td><td>TUI で選択時のコピーを無効にする</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_BASH_DEFAULT_TIMEOUT_MS</code></td><td>数値</td><td>bash コマンドのデフォルトのタイムアウト (ミリ秒)</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_OUTPUT_TOKEN_MAX</code></td><td>数値</td><td>LLM 応答の最大出力トークン</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_FILEWATCHER</code></td><td>ブール値</td><td>ディレクトリ全体のファイル監視を有効にする</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_OXFMT</code></td><td>ブール値</td><td>oxfmt フォーマッタを有効にする</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_LSP_TOOL</code></td><td>ブール値</td><td>実験的な LSP ツールを有効にする</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_DISABLE_FILEWATCHER</code></td><td>ブール値</td><td>ファイルウォッチャーを無効にする</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_EXA</code></td><td>ブール値</td><td>実験的な Exa 機能を有効にする</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_LSP_TY</code></td><td>ブール値</td><td>python ファイルの TY LSP を有効にする</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_PLAN_MODE</code></td><td>ブール値</td><td>プランモードを有効にする</td></tr></tbody></table>"
    })]
  });
}
...
const file = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/ja/cli.mdx";
...
Content.moduleId = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/ja/cli.mdx";
