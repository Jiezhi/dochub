...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(Fragment$1, {
      ...
      children: ["Deneme sürenizi tamamladıktan ve opencode’u şu adreste kullanmaya hazır olduğunuzda:\nkuruluşunuz hakkında görüşmek üzere ", createVNode(_components.strong, {
        children: createVNode("a", {
          href: email,
      ...
      "set:html": "<hr>\n<h2 id=\"sss\"><a href=\"#sss\">SSS</a></h2>\n<details><summary>opencode Enterprise nedir?</summary><p>opencode Enterprise, kodlarının ve verilerinin altyapılarından asla ayrılmamasını sağlamak isteyen kuruluşlar içindir. Bunu, SSO ve dahili AI ağ geçidinizle entegre olan merkezi bir yapılandırma kullanarak yapabilir.</p></details>\n"
    }), createVNode(_components.details, {
      children: [createVNode(_components.summary, {
        children: "opencode Enterprise’a nasıl başlarım?"
      }), createVNode(_components.p, {
        children: "Ekibinizle dahili bir denemeyle başlayın. opencode varsayılan olarak kodunuzu veya içerik verilerinizi saklamaz, bu da başlamayı kolaylaştırır."
      }), createVNode(_components.p, {
...
const file = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/tr/enterprise.mdx";
...
Content.moduleId = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/tr/enterprise.mdx";
