...
function getHeadings() {
  return [{
    ...
    "depth": 2,
    "slug": "saída-estruturada",
    "text": "Saída Estruturada"
  }, {
    "depth": 3,
    "slug": "uso-básico",
    "text": "Uso Básico"
    ...
    "depth": 3,
    "slug": "tipos-de-formato-de-saída",
    "text": "Tipos de Formato de Saída"
  }, {
    "depth": 3,
    "slug": "formato-do-esquema-json",
    "text": "Formato do Esquema JSON"
  }, {
    "depth": 3,
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            children: "Escrever uma entrada de log"
          }), createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
              children: "boolean"
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            children: "Listar sessões"
          }), createVNode(_components.td, {
            children: ["Retorna ", createVNode("a", {
              href: typesUrl,
          ...
          children: [createVNode(_components.td, {
            ...
            children: "Listar sessões filhas"
          }), createVNode(_components.td, {
            children: ["Retorna ", createVNode("a", {
              href: typesUrl,
              "set:html": "<code>Session[]</code>"
          ...
          "set:html": "<td><code dir=\"auto\">session.delete({ path })</code></td><td>Deletar sessão</td><td>Retorna <code dir=\"auto\">boolean</code></td>"
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
          ...
          "set:html": "<tr><td><code dir=\"auto\">session.init({ path, body })</code></td><td>Analisar app e criar <code dir=\"auto\">AGENTS.md</code></td><td>Retorna <code dir=\"auto\">boolean</code></td></tr><tr><td><code dir=\"auto\">session.abort({ path })</code></td><td>Abortar uma sessão em execução</td><td>Retorna <code dir=\"auto\">boolean</code></td></tr>"
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
          ...
          children: [createVNode(_components.td, {
            ...
            children: "Descompartilhar sessão"
          }), createVNode(_components.td, {
            children: ["Retorna ", createVNode("a", {
              href: typesUrl,
              "set:html": "<code>Session</code>"
          ...
          "set:html": "<td><code dir=\"auto\">session.summarize({ path, body })</code></td><td>Resumir sessão</td><td>Retorna <code dir=\"auto\">boolean</code></td>"
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
            ...
            children: ["Retorna ", createVNode(_components.code, {
              dir: "auto",
              children: "{ info: "
            }), createVNode("a", {
              href: typesUrl,
          ...
          children: [createVNode(_components.td, {
            ...
            children: "Enviar mensagem de prompt"
          }), createVNode(_components.td, {
            children: [createVNode(_components.code, {
              dir: "auto",
              children: "body.noReply: true"
            }), " retorna UserMessage (apenas contexto). O padrão retorna ", createVNode("a", {
              href: typesUrl,
              "set:html": "<code>AssistantMessage</code>"
            }), " com resposta da AI. Suporta ", createVNode(Fragment$1, {
              "set:html": "<code dir=\"auto\">body.outputFormat</code> para <a href=\"#sa%C3%ADda-estruturada\">saída estruturada</a>"
            })]
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            children: "Enviar comando para a sessão"
          }), createVNode(_components.td, {
            children: ["Retorna ", createVNode(_components.code, {
              dir: "auto",
              children: "{ info: "
          ...
          children: [createVNode(_components.td, {
            ...
            children: "Reverter uma mensagem"
          }), createVNode(_components.td, {
            children: ["Retorna ", createVNode("a", {
              href: typesUrl,
              "set:html": "<code>Session</code>"
          ...
          children: [createVNode(_components.td, {
            ...
            children: "Restaurar mensagens revertidas"
          }), createVNode(_components.td, {
            children: ["Retorna ", createVNode("a", {
              href: typesUrl,
              "set:html": "<code>Session</code>"
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            children: ["Array de objetos de correspondência com ", createVNode(_components.code, {
              dir: "auto",
              children: "path"
            }), ", ", createVNode(_components.code, {
              dir: "auto",
          ...
          children: [createVNode(_components.td, {
            ...
            children: "Encontrar símbolos no workspace"
          }), createVNode(_components.td, {
            children: createVNode("a", {
              href: typesUrl,
          ...
          "set:html": "<td><code dir=\"auto\">file.read({ query })</code></td><td>Ler um arquivo</td><td><code dir=\"auto\">{ type: \"raw\" | \"patch\", content: string }</code></td>"
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
...
const url = "src/content/docs/pt-br/sdk.mdx";
const file = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/pt-br/sdk.mdx";
...
Content.moduleId = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/pt-br/sdk.mdx";
