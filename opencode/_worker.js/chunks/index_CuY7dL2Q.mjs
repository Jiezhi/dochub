...
import { r as requirePostcss, i as postcss, j as h, D as Declaration, c as addClassName$1, s as setInlineStyle$1 } from './Code_CadJumwV.mjs';
import { aF as requireCssesc, ai as commonjsGlobal, aj as getDefaultExportFromCjs } from './astro/server_D-7CwiXF.mjs';
...
function getFileNameFromComment(line, lang) {
  ...
  if (!possibleFileName)
    return;
  if (textBeforeFileName.trim().toLowerCase() === "@filename")
    return;
...
export { AnnotationRenderPhaseOrder as A, runHooks as B, setAlpha as C, setLuminance as D, ExpressiveCodeTheme as E, stableStringify as F, toHexColor as G, validateExpressiveCodeAnnotation as H, InlineStyleAnnotation as I, LanguageGroups as L, MetaOptions as M, PluginStyleSettings as P, ExpressiveCodeEngine as a, pluginTextMarkers as b, pluginFrames as c, ExpressiveCodeAnnotation as d, ExpressiveCodeBlock as e, ExpressiveCodeLine as f, getStableObjectHash as g, LanguagesWithFencedFrontmatter as h, PluginTexts as i, changeAlphaToReachColorContrast as j, changeLuminanceToReachColorContrast as k, chromaticRecolor as l, codeLineClass as m, createInlineSvgUrl as n, darken as o, pluginFramesTexts as p, ensureColorContrastOnBackground as q, getCssVarName as r, getFirstStaticColor as s, getLuminance as t, getStaticBackgroundColor as u, isInlineStyleAnnotation as v, lighten as w, multiplyAlpha as x, onBackground as y, resolveStyleVariants as z };
