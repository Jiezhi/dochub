...
function getHeadings() {
  return [{
    ...
    "depth": 2,
    "slug": "global-bayraklar",
    "text": "Global bayraklar"
  }, {
    "depth": 2,
    "slug": "ortam-değişkenleri",
...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(Fragment$1, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-c</code></td><td>Son oturuma devam et</td>"
          })]
          ...
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-s</code></td><td>Devam edecek oturum kimliği</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>Devam ederken oturumu fork’lar (<code dir=\"auto\">--continue</code> veya <code dir=\"auto\">--session</code> ile kullanın)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>Kullanılacak prompt</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td><code dir=\"auto\">-m</code></td><td>provider/model biçiminde kullanılacak model</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>Kullanılacak agent</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>Dinlenecek port</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td></td><td>TUI’yi başlatmak için çalışma dizini</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
          ...
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-s</code></td><td>Devam edecek oturum açma bilgileri</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>Devam ederken oturumu çatalla (<code dir=\"auto\">--continue</code> veya <code dir=\"auto\">--session</code> ile kullanın)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td><code dir=\"auto\">-p</code></td><td>Temel kimlik doğrulama parolası (varsayılan: <code dir=\"auto\">OPENCODE_SERVER_PASSWORD</code>)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "Aracıyı çalıştırmak için GitHub sahte olayı"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "Modeller.dev’den model önbelleğini yenileyin"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td></td><td>Çalıştırılacak komut, args için mesajı kullanın</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
          ...
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td></td><td>Oturumu paylaşın</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
          ...
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td></td><td>Kullanılacak temsilci</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td><code dir=\"auto\">-f</code></td><td>Mesaja eklenecek dosya(lar)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>Biçim: varsayılan (biçimlendirilmiş) veya json (ham JSON olayları)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>Oturumun başlığı (değer sağlanmazsa kısaltılmış bilgi istemi kullanılır)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>Çalışan bir opencode sunucusuna ekleyin (ör. <a href=\"http://localhost:4096\">http://localhost:4096</a>)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
          ...
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td></td><td>Çalıştırılacak dizin veya bağlanırken uzak sunucudaki yol</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>Model varyantı (sağlayıcıya özgü muhakeme düzeyi)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>Düşünme bloklarını göster</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>Yerel sunucunun bağlantı noktası (varsayılan olarak rastgele bağlantı noktasıdır)</td>"
          })]
        })]
      })]
    }), "\n", createVNode(Fragment$1, {
      "set:html": "<hr>\n<h3 id=\"serve\"><a href=\"#serve\">serve</a></h3>\n<p>API erişimi için headless bir opencode sunucusu başlatır. Tam HTTP arayüzü için <a href=\"/docs/server\">server docs</a> sayfasına bakın.</p>\n<div class=\"expressive-code\"><figure class=\"frame is-terminal not-content\"><figcaption class=\"header\"><span class=\"title\"></span><span class=\"sr-only\">Terminal window</span></figcaption><pre data-language=\"bash\"><code><div class=\"ec-line\"><div class=\"code\"><span style=\"--0:#6F42C1;--1:#B392F0\">opencode</span><span style=\"--0:#24292E;--1:#E1E4E8\"> </span><span style=\"--0:#032F62;--1:#9ECBFF\">serve</span></div></div></code></pre><div class=\"copy\"><div aria-live=\"polite\"></div><button title=\"Copy to clipboard\" data-copied=\"Copied!\" data-code=\"opencode serve\"><div></div></button></div></figure></div>\n<p>Bu, TUI arayüzü olmadan opencode işlevselliğine API erişimi sağlayan bir HTTP sunucusunu başlatır. HTTP temel kimlik doğrulamasını etkinleştirmek için <code dir=\"auto\">OPENCODE_SERVER_PASSWORD</code> öğesini ayarlayın (kullanıcı adı varsayılan olarak <code dir=\"auto\">opencode</code> şeklindedir).</p>\n<h4 id=\"bayraklar-5\"><a href=\"#bayraklar-5\">Bayraklar</a></h4>\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n"
    }), createVNode(_components.table, {
      children: [createVNode(_components.thead, {
        children: createVNode(_components.tr, {
          children: [createVNode(_components.th, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "Dinlenecek bağlantı noktası"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "Dinlenecek ana bilgisayar adı"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "mDNS bulmayı etkinleştir"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-n</code></td><td>En son N oturumla sınırla</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>Çıkış formatı: tablo veya json (tablo)</td>"
          })]
        })]
      })]
    }), "\n", createVNode(Fragment$1, {
      "set:html": "<hr>\n<h3 id=\"stats\"><a href=\"#stats\">stats</a></h3>\n<p>opencode oturumlarınız için belirteç kullanımı ve maliyet istatistiklerini gösterin.</p>\n<div class=\"expressive-code\"><figure class=\"frame is-terminal not-content\"><figcaption class=\"header\"><span class=\"title\"></span><span class=\"sr-only\">Terminal window</span></figcaption><pre data-language=\"bash\"><code><div class=\"ec-line\"><div class=\"code\"><span style=\"--0:#6F42C1;--1:#B392F0\">opencode</span><span style=\"--0:#24292E;--1:#E1E4E8\"> </span><span style=\"--0:#032F62;--1:#9ECBFF\">stats</span></div></div></code></pre><div class=\"copy\"><div aria-live=\"polite\"></div><button title=\"Copy to clipboard\" data-copied=\"Copied!\" data-code=\"opencode stats\"><div></div></button></div></figure></div>\n<h4 id=\"bayraklar-7\"><a href=\"#bayraklar-7\">Bayraklar</a></h4>\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n"
    }), createVNode(_components.table, {
      children: [createVNode(_components.thead, {
        children: createVNode(_components.tr, {
          children: [createVNode(_components.th, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "Son N güne ait istatistikleri göster (tüm zamanlar)"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "Gösterilecek araç sayısı (tümü)"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "Model kullanım dökümünü göster (varsayılan olarak gizlidir). En üstteki N’yi göstermek için bir sayı iletin"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      "set:html": "<hr>\n<h3 id=\"acp\"><a href=\"#acp\">acp</a></h3>\n<p>Bir ACP (Ajan İstemci Protokolü) sunucusu başlatın.</p>\n<div class=\"expressive-code\"><figure class=\"frame is-terminal not-content\"><figcaption class=\"header\"><span class=\"title\"></span><span class=\"sr-only\">Terminal window</span></figcaption><pre data-language=\"bash\"><code><div class=\"ec-line\"><div class=\"code\"><span style=\"--0:#6F42C1;--1:#B392F0\">opencode</span><span style=\"--0:#24292E;--1:#E1E4E8\"> </span><span style=\"--0:#032F62;--1:#9ECBFF\">acp</span></div></div></code></pre><div class=\"copy\"><div aria-live=\"polite\"></div><button title=\"Copy to clipboard\" data-copied=\"Copied!\" data-code=\"opencode acp\"><div></div></button></div></figure></div>\n<p>Bu komut, nd-JSON kullanarak stdin/stdout aracılığıyla iletişim kuran bir ACP sunucusunu başlatır.</p>\n<h4 id=\"bayraklar-9\"><a href=\"#bayraklar-9\">Bayraklar</a></h4>\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n"
    }), createVNode(_components.table, {
      children: [createVNode(_components.thead, {
        children: createVNode(_components.tr, {
          children: [createVNode(_components.th, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-c</code></td><td>Yapılandırma dosyalarını sakla</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td><code dir=\"auto\">-d</code></td><td>Oturum verilerini ve anlık görüntüleri saklayın</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>Nelerin kaldırılmadan kaldırılacağı göster</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-m</code></td><td>Kullanılan kurulum yöntemi: curl, npm, pnpm, bun, brew</td>"
          })]
        })
      })]
    }), "\n", createVNode(Fragment$1, {
      "set:html": "<hr>\n<h2 id=\"global-bayraklar\"><a href=\"#global-bayraklar\">Global bayraklar</a></h2>\n<p>opencode CLI aşağıdaki global bayrakları destekler.</p>\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n"
    }), createVNode(_components.table, {
      children: [createVNode(_components.thead, {
        children: createVNode(_components.tr, {
          children: [createVNode(_components.th, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-h</code></td><td>Yardımı görüntüle</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td><code dir=\"auto\">-v</code></td><td>Sürüm numarasını yazdır</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>Günlükleri stderr’e yazdır</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>Günlük düzeyi (DEBUG, INFO, WARN, ERROR)</td>"
          })]
        })]
      })]
    }), "\n", createVNode(Fragment$1, {
      "set:html": "<hr>\n<h2 id=\"ortam-değişkenleri\"><a href=\"#ortam-değişkenleri\">Ortam değişkenleri</a></h2>\n<p>opencode ortam değişkenleri kullanılarak yapılandırılabilir.</p>\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n<table><thead><tr><th>Değişken</th><th>Tip</th><th>Açıklama</th></tr></thead><tbody><tr><td><code dir=\"auto\">OPENCODE_AUTO_SHARE</code></td><td>boolean</td><td>Oturumları otomatik olarak paylaş</td></tr><tr><td><code dir=\"auto\">OPENCODE_GIT_BASH_PATH</code></td><td>string</td><td>Windows’ta yürütülebilir Git Bash’in Yolu</td></tr><tr><td><code dir=\"auto\">OPENCODE_CONFIG</code></td><td>string</td><td>Yapılandırma dosyasının yolu</td></tr><tr><td><code dir=\"auto\">OPENCODE_TUI_CONFIG</code></td><td>string</td><td>TUI yapılandırma dosyasının yolu</td></tr><tr><td><code dir=\"auto\">OPENCODE_CONFIG_DIR</code></td><td>string</td><td>Yapılandırma dizinine giden yol</td></tr><tr><td><code dir=\"auto\">OPENCODE_CONFIG_CONTENT</code></td><td>string</td><td>Satır içi JSON config içeriği</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_AUTOUPDATE</code></td><td>boolean</td><td>Otomatik güncelleme kontrollerini devre dışı bırak</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_PRUNE</code></td><td>boolean</td><td>Eski verilerin temizlenmesini devre dışı bırak</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_TERMINAL_TITLE</code></td><td>boolean</td><td>Otomatik terminal başlığı güncellemelerini devre dışı bırakın</td></tr><tr><td><code dir=\"auto\">OPENCODE_PERMISSION</code></td><td>string</td><td>Satır içi JSON izin config’i</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_DEFAULT_PLUGINS</code></td><td>boolean</td><td>Varsayılan eklentileri devre dışı bırakın</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_LSP_DOWNLOAD</code></td><td>boolean</td><td>Otomatik LSP sunucu indirmelerini devre dışı bırakın</td></tr><tr><td><code dir=\"auto\">OPENCODE_ENABLE_EXPERIMENTAL_MODELS</code></td><td>boolean</td><td>Deneysel modelleri etkinleştir</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_AUTOCOMPACT</code></td><td>boolean</td><td>Otomatik context sıkıştırmayı devre dışı bırak</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_CLAUDE_CODE</code></td><td>boolean</td><td><code dir=\"auto\">.claude</code>’den okumayı devre dışı bırak (istem + beceriler)</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_CLAUDE_CODE_PROMPT</code></td><td>boolean</td><td><code dir=\"auto\">~/.claude/CLAUDE.md</code> dosyasını okumayı devre dışı bırak</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_CLAUDE_CODE_SKILLS</code></td><td>boolean</td><td><code dir=\"auto\">.claude/skills</code> yüklemesini devre dışı bırak</td></tr><tr><td><code dir=\"auto\">OPENCODE_DISABLE_MODELS_FETCH</code></td><td>boolean</td><td>Uzak kaynaklardan model getirmeyi devre dışı bırakın</td></tr><tr><td><code dir=\"auto\">OPENCODE_FAKE_VCS</code></td><td>string</td><td>Test amaçlı sahte VCS sağlayıcısı</td></tr><tr><td><code dir=\"auto\">OPENCODE_CLIENT</code></td><td>string</td><td>Client kimliği (varsayılan: <code dir=\"auto\">cli</code>)</td></tr><tr><td><code dir=\"auto\">OPENCODE_ENABLE_EXA</code></td><td>boolean</td><td>Exa web arama araçlarını etkinleştir</td></tr><tr><td><code dir=\"auto\">OPENCODE_SERVER_PASSWORD</code></td><td>string</td><td><code dir=\"auto\">serve</code>/<code dir=\"auto\">web</code> için temel kimlik doğrulamayı etkinleştirin</td></tr><tr><td><code dir=\"auto\">OPENCODE_SERVER_USERNAME</code></td><td>string</td><td>Temel kimlik doğrulama kullanıcı adını geçersiz kıl (varsayılan <code dir=\"auto\">opencode</code>)</td></tr><tr><td><code dir=\"auto\">OPENCODE_MODELS_URL</code></td><td>string</td><td>Model yapılandırmasını almak için özel URL</td></tr></tbody></table>\n<hr>\n<h3 id=\"deneysel\"><a href=\"#deneysel\">Deneysel</a></h3>\n<p>Bu ortam değişkenleri değişebilecek veya kaldırılabilecek deneysel özellikleri etkinleştirir.</p>\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n<table><thead><tr><th>Değişken</th><th>Tip</th><th>Tanım</th></tr></thead><tbody><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL</code></td><td>boolean</td><td>Tüm deneysel özellikleri etkinleştir</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_ICON_DISCOVERY</code></td><td>boolean</td><td>Simge bulmayı etkinleştir</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_DISABLE_COPY_ON_SELECT</code></td><td>boolean</td><td>TUI’da seçim yapıldığında kopyalamayı devre dışı bırak</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_BASH_DEFAULT_TIMEOUT_MS</code></td><td>number</td><td>MS cinsinden bash komutları için varsayılan zaman aşımı</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_OUTPUT_TOKEN_MAX</code></td><td>number</td><td>LLM yanıtları için maksimum çıktı belirteçleri</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_FILEWATCHER</code></td><td>boolean</td><td>Tüm dizin için dosya izleyiciyi etkinleştir</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_OXFMT</code></td><td>boolean</td><td>Oxfmt biçimlendiriciyi etkinleştir</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_LSP_TOOL</code></td><td>boolean</td><td>Deneysel LSP aracını etkinleştir</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_DISABLE_FILEWATCHER</code></td><td>boolean</td><td>Dosya izleyiciyi devre dışı bırak</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_EXA</code></td><td>boolean</td><td>Deneysel Exa özelliklerini etkinleştirin</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_LSP_TY</code></td><td>boolean</td><td>python dosyaları için TY LSP’yi etkinleştir</td></tr><tr><td><code dir=\"auto\">OPENCODE_EXPERIMENTAL_PLAN_MODE</code></td><td>boolean</td><td>Plan modunu etkinleştir</td></tr></tbody></table>"
    })]
  });
}
...
const url = "src/content/docs/tr/cli.mdx";
const file = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/tr/cli.mdx";
...
Content.moduleId = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/tr/cli.mdx";
