...
function getHeadings() {
  return [{
    ...
    "depth": 3,
    "slug": "opencode-не-запускается",
    "text": "opencode не запускается"
  }, {
    "depth": 3,
...
const file = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/ru/troubleshooting.mdx";
...
Content.moduleId = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/ru/troubleshooting.mdx";
