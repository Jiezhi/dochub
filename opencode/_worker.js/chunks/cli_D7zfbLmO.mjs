      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-c</code></td><td>마지막 세션 이어서 실행</td>"
          })]
          ...
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-s</code></td><td>이어서 실행할 세션 ID</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>세션을 이어갈 때 포크 생성 (<code dir=\"auto\">--continue</code> 또는 <code dir=\"auto\">--session</code>과 함께 사용)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
          ...
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-m</code></td><td>사용할 모델 (<code dir=\"auto\">provider/model</code> 형식)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td></td><td>TUI를 시작할 작업 디렉터리</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
          ...
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td></td><td>이어서 실행할 때 세션 포크 (<code dir=\"auto\">--continue</code> 또는 <code dir=\"auto\">--session</code>과 함께 사용)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td><code dir=\"auto\">-p</code></td><td>기본 인증 비밀번호 (기본값: <code dir=\"auto\">OPENCODE_SERVER_PASSWORD</code>)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "models.dev에서 모델 캐시 새로고침"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td></td><td>실행할 명령(인수는 message로 전달)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
          ...
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-f</code></td><td>메시지에 첨부할 파일</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>출력 형식: default(포맷됨) 또는 json(원시 JSON 이벤트)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>세션 제목(값이 없으면 프롬프트를 잘라 자동 생성)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>실행 중인 opencode 서버에 연결(예: <a href=\"http://localhost:4096\">http://localhost:4096</a>)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
          ...
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td></td><td>실행할 디렉터리, 또는 연결 시 원격 서버 경로</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>모델 변형 (제공자별 추론 수준)</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
          ...
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td></td><td>로컬 서버 포트(기본값: 랜덤 포트)</td>"
          })]
        })]
      })]
    }), "\n", createVNode(Fragment$1, {
      "set:html": "<hr>\n<h3 id=\"serve\"><a href=\"#serve\">serve</a></h3>\n<p>API 접근용 headless OpenCode 서버를 시작합니다. 전체 HTTP 인터페이스는 <a href=\"/docs/server\">server docs</a>를 참고하세요.</p>\n<div class=\"expressive-code\"><figure class=\"frame is-terminal not-content\"><figcaption class=\"header\"><span class=\"title\"></span><span class=\"sr-only\">Terminal window</span></figcaption><pre data-language=\"bash\"><code><div class=\"ec-line\"><div class=\"code\"><span style=\"--0:#6F42C1;--1:#B392F0\">opencode</span><span style=\"--0:#24292E;--1:#E1E4E8\"> </span><span style=\"--0:#032F62;--1:#9ECBFF\">serve</span></div></div></code></pre><div class=\"copy\"><div aria-live=\"polite\"></div><button title=\"Copy to clipboard\" data-copied=\"Copied!\" data-code=\"opencode serve\"><div></div></button></div></figure></div>\n<p>이 명령은 TUI 없이 opencode 기능에 접근할 수 있는 HTTP 서버를 시작합니다. <code dir=\"auto\">OPENCODE_SERVER_PASSWORD</code>를 설정하면 HTTP basic auth가 활성화됩니다(기본 사용자명: <code dir=\"auto\">opencode</code>).</p>\n<h4 id=\"플래그-5\"><a href=\"#플래그-5\">플래그</a></h4>\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n"
    }), createVNode(_components.table, {
      children: [createVNode(_components.thead, {
        children: createVNode(_components.tr, {
          children: [createVNode(_components.th, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-n</code></td><td>최근 N개 세션만 표시</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "최근 N일 통계 표시(기본값: 전체 기간)"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
          ...
          children: [createVNode(_components.td, {
            ...
            "set:html": "모델 사용량 상세 표시(기본 숨김). 숫자를 주면 상위 N개 표시"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-c</code></td><td>설정 파일 유지</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td><code dir=\"auto\">-d</code></td><td>세션 데이터와 스냅샷 유지</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>실제 삭제 없이 삭제 대상만 표시</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-m</code></td><td>설치 방식 지정: curl, npm, pnpm, bun, brew</td>"
          })]
        })
      })]
    }), "\n", createVNode(Fragment$1, {
      "set:html": "<hr>\n<h2 id=\"전역-플래그\"><a href=\"#전역-플래그\">전역 플래그</a></h2>\n<p>opencode CLI는 아래 전역 플래그를 지원합니다.</p>\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n"
    }), createVNode(_components.table, {
      children: [createVNode(_components.thead, {
        children: createVNode(_components.tr, {
          children: [createVNode(_components.th, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            "set:html": "<td><code dir=\"auto\">-h</code></td><td>도움말 표시</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td><code dir=\"auto\">-v</code></td><td>버전 출력</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
            ...
            "set:html": "<td></td><td>로그를 stderr로 출력</td>"
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.nobr, {
...
const file = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/ko/cli.mdx";
...
Content.moduleId = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/ko/cli.mdx";
