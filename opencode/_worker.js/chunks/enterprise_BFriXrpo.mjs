...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(Fragment$1, {
      ...
      "set:html": "<hr>\n<h2 id=\"常见问题\"><a href=\"#常见问题\">常见问题</a></h2>\n<details><summary>什么是 OpenCode 企业版？</summary><p>OpenCode 企业版面向希望确保代码和数据始终留在自有基础设施内的组织。它通过集中式配置与您的 SSO 和内部 AI 网关集成来实现这一目标。</p></details>\n"
    }), createVNode(_components.details, {
      children: [createVNode(_components.summary, {
        children: "如何开始使用 OpenCode 企业版？"
      }), createVNode(_components.p, {
        children: "只需在团队内部开始试用即可。OpenCode 默认不存储您的代码或上下文数据，因此可以轻松上手。"
      }), createVNode(_components.p, {
...
const file = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/zh-cn/enterprise.mdx";
...
Content.moduleId = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/zh-cn/enterprise.mdx";
