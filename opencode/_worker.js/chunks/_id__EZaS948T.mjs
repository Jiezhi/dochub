...
import { c as createAstro, a as createComponent, r as renderComponent, b as renderTemplate, q as renderSlot } from './astro/server_D-7CwiXF.mjs';
import { H as HeadConfigSchema, b as urlToSlug, c as slugToLocaleData, d as getSidebarFromConfig, e as getSidebar, f as getSiteTitle, h as getToC, i as getSiteTitleHref, j as getPrevNextLinks, k as getHead, a as attachRouteDataAndRunMiddleware, $ as $$Page, l as gBase64 } from './middleware_B6SKGTvj.mjs';
import { a as stripLeadingAndTrailingSlashes, b as getCollectionPathFromRoot, p as project, s as starlightConfig } from './translations_CDEHKrA8.mjs';
import { I as Icons, d as I18nBadgeConfigSchema, B as BadgeConfigSchema, p as parseAsyncWithFriendlyErrors, e as parseWithFriendlyErrors } from './Code_CadJumwV.mjs';
import { u as unionType, b as booleanType, s as stringType, o as objectType, n as numberType, e as enumType, r as recordType, a as undefinedType, l as lazyType, d as dateType, c as custom } from './types_DmpsJMYk.mjs';
...
async function getUserDocsSchema() {
  const userCollections = (await import('./collection-config_yZkr9oVj.mjs')).collections;
...
}, "/home/runner/work/dochub/dochub/_src/node_modules/.bun/@astrojs+starlight@0.34.3+78462a26e97dd9d0/node_modules/@astrojs/starlight/components/StarlightPage.astro", void 0);
...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const modelParam = modelsArray.length === 1 ? modelsArray[0] : modelsArray.length === 2 ? encodeURIComponent(`${modelsArray[0]} & ${modelsArray[1]}`) : encodeURIComponent(`${modelsArray[0]} & ${modelsArray.length - 1} others`);
  ...
  } }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Share", null, { "id": id, "api": apiUrl, "info": data.info, "messages": messages, "client:only": "solid", "client:component-hydration": "only", "client:component-path": "/home/runner/work/dochub/dochub/_src/packages/web/src/components/Share.tsx", "client:component-export": "default" })} ` })} `;
}, "/home/runner/work/dochub/dochub/_src/packages/web/src/pages/s/[id].astro", void 0);
const $$file = "/home/runner/work/dochub/dochub/_src/packages/web/src/pages/s/[id].astro";
const $$url = "/docs/s/[id]";
