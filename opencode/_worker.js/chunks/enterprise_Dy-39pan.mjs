...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(Fragment$1, {
      ...
      children: ["Når du har fullført prøveversjonen og du er klar til å bruke OpenCode på\norganisasjonen din, kan du ", createVNode(_components.strong, {
        children: createVNode("a", {
          href: email,
      ...
      "set:html": "<hr>\n<h2 id=\"ofte-stilte-spørsmål-faq\"><a href=\"#ofte-stilte-spørsmål-faq\">Ofte stilte spørsmål (FAQ)</a></h2>\n<details><summary>Hva er OpenCode Enterprise?</summary><p>OpenCode Enterprise er for organisasjoner som ønsker å sikre at deres kode og data aldri forlater deres infrastruktur. Den kan gjøre dette ved å bruke en sentralisert konfigurasjon som integreres med din SSO og interne AI gateway.</p></details>\n"
      ...
      children: [createVNode(_components.summary, {
        ...
        children: "Bare sett i gang en intern prøveversjon med teamet ditt. OpenCode lagrer som standard ikke koden eller kontekstdataene dine, noe som gjør det enkelt å komme i gang."
      }), createVNode(_components.p, {
...
const file = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/nb/enterprise.mdx";
...
Content.moduleId = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/nb/enterprise.mdx";
