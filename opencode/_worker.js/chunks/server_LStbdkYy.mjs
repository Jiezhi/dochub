    ...
    children: [createVNode(Fragment$1, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          ...
          "set:html": "<td><code dir=\"auto\">POST</code></td><td><code dir=\"auto\">/provider/{id}/oauth/callback</code></td><td>Manejar la devolución de llamada OAuth para un proveedor</td><td><code dir=\"auto\">boolean</code></td>"
        })]
      })]
    }), "\n", createVNode(Fragment$1, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          ...
          children: [createVNode(_components.td, {
            ...
            children: ["cuerpo: ", createVNode(_components.code, {
              dir: "auto",
              children: "{ parentID?, title? }"
            }), ", devuelve ", createVNode("a", {
              href: typesUrl,
              "set:html": "<code>Session</code>"
            })]
          })]
          ...
          "set:html": "<td><code dir=\"auto\">DELETE</code></td><td><code dir=\"auto\">/session/:id</code></td><td>Eliminar una sesión y todos sus datos</td><td>Devuelve <code dir=\"auto\">boolean</code></td>"
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
          ...
          "set:html": "<td><code dir=\"auto\">POST</code></td><td><code dir=\"auto\">/session/:id/init</code></td><td>Analizar aplicación y crear <code dir=\"auto\">AGENTS.md</code></td><td>cuerpo: <code dir=\"auto\">{ messageID, providerID, modelID }</code>, devuelve <code dir=\"auto\">boolean</code></td>"
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
          ...
          "set:html": "<td><code dir=\"auto\">POST</code></td><td><code dir=\"auto\">/session/:id/abort</code></td><td>Cancelar una sesión en ejecución</td><td>Devuelve <code dir=\"auto\">boolean</code></td>"
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
          ...
          children: [createVNode(_components.td, {
            ...
            children: ["consulta: ", createVNode(_components.code, {
              dir: "auto",
              children: "messageID?"
            }), ", devuelve ", createVNode("a", {
              href: typesUrl,
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          ...
          "set:html": "<td><code dir=\"auto\">POST</code></td><td><code dir=\"auto\">/session/:id/prompt_async</code></td><td>Enviar un mensaje de forma asincrónica (sin espera)</td><td>cuerpo: igual que <code dir=\"auto\">/session/:id/message</code>, devuelve <code dir=\"auto\">204 No Content</code></td>"
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          ...
          "set:html": "<td><code dir=\"auto\">POST</code></td><td><code dir=\"auto\">/mcp</code></td><td>Agregue el servidor MCP dinámicamente</td><td>cuerpo: <code dir=\"auto\">{ name, config }</code>, devuelve MCP objeto de estado</td>"
        })]
      })]
    }), "\n", createVNode(Fragment$1, {
...
const file = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/es/server.mdx";
...
Content.moduleId = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/es/server.mdx";
