...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(Fragment$1, {
      ...
      children: ["Sobald Sie Ihre Testversion abgeschlossen haben und bereit sind, OpenCode unter zu verwenden\nFür Ihre Organisation können Sie ", createVNode(_components.strong, {
        children: createVNode("a", {
          href: email,
      ...
      "set:html": "<hr>\n<h2 id=\"faq\"><a href=\"#faq\">FAQ</a></h2>\n<details><summary>Was ist OpenCode Enterprise?</summary><p>OpenCode Enterprise ist für Organisationen gedacht, die sicherstellen möchten, dass ihr Code und ihre Daten niemals ihre Infrastruktur verlassen. Dies kann durch die Verwendung einer zentralen Konfiguration erreicht werden, die in Ihr SSO- und internes AI-Gateway integriert ist.</p></details>\n"
    }), createVNode(_components.details, {
      children: [createVNode(_components.summary, {
        children: "Wie fange ich mit OpenCode Enterprise an?"
      }), createVNode(_components.p, {
        children: "Beginnen Sie einfach mit einem internen Test mit Ihrem Team. OpenCode speichert standardmäßig weder Ihren Code noch Ihre Kontextdaten, was den Einstieg erleichtert."
      }), createVNode(_components.p, {
...
const file = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/de/enterprise.mdx";
...
Content.moduleId = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/de/enterprise.mdx";
