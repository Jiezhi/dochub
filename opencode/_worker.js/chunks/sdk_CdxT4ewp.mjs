...
function getHeadings() {
  return [{
    ...
    "depth": 3,
    "slug": "tipos-de-formato-de-salida",
    "text": "Tipos de Formato de Salida"
  }, {
    "depth": 3,
    "slug": "formato-de-esquema-json",
    "text": "Formato de Esquema JSON"
  }, {
    "depth": 3,
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            children: ["Devuelve ", createVNode("a", {
              href: typesUrl,
          ...
          "set:html": "<td><code dir=\"auto\">session.delete({ path })</code></td><td>Eliminar sesión</td><td>Devuelve <code dir=\"auto\">boolean</code></td>"
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
          ...
          "set:html": "<tr><td><code dir=\"auto\">session.init({ path, body })</code></td><td>Analizar aplicación y crear <code dir=\"auto\">AGENTS.md</code></td><td>Devuelve <code dir=\"auto\">boolean</code></td></tr><tr><td><code dir=\"auto\">session.abort({ path })</code></td><td>Cancelar una sesión en ejecución</td><td>Devuelve <code dir=\"auto\">boolean</code></td></tr>"
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
          ...
          "set:html": "<td><code dir=\"auto\">session.summarize({ path, body })</code></td><td>Resumir sesión</td><td>Devuelve <code dir=\"auto\">boolean</code></td>"
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
            ...
            children: ["Devuelve ", createVNode(_components.code, {
              dir: "auto",
              children: "{ info: "
            }), createVNode("a", {
              href: typesUrl,
          ...
          children: [createVNode(_components.td, {
            ...
            }), " devuelve UserMessage (solo contexto). El valor predeterminado devuelve ", createVNode("a", {
              href: typesUrl,
              "set:html": "<code>AssistantMessage</code>"
            }), " con respuesta de IA. Admite ", createVNode(Fragment$1, {
              "set:html": "<code dir=\"auto\">body.outputFormat</code> para <a href=\"#salida-estructurada\">salida estructurada</a>"
            })]
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            children: ["Matriz de objetos coincidentes con ", createVNode(_components.code, {
              dir: "auto",
              children: "path"
            }), ", ", createVNode(_components.code, {
              dir: "auto",
          ...
          "set:html": "<td><code dir=\"auto\">file.read({ query })</code></td><td>Leer un archivo</td><td><code dir=\"auto\">{ type: \"raw\" | \"patch\", content: string }</code></td>"
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
...
const file = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/es/sdk.mdx";
...
Content.moduleId = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/es/sdk.mdx";
