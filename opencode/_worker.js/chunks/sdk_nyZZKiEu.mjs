...
function getHeadings() {
  return [{
    ...
    "depth": 2,
    "slug": "struktureret-output",
    "text": "Struktureret output"
  }, {
    "depth": 3,
    "slug": "grundlæggende-brug",
    "text": "Grundlæggende brug"
  }, {
    "depth": 3,
    "slug": "outputformat-typer",
    "text": "Outputformat-typer"
  }, {
    "depth": 3,
    "slug": "json-skemaformat",
    "text": "JSON-skemaformat"
  }, {
    "depth": 3,
    "slug": "fejlhåndtering",
    "text": "Fejlhåndtering"
    ...
    children: [createVNode(Fragment$1, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          ...
          "set:html": "<td><code dir=\"auto\">session.delete({ path })</code></td><td>Slett session</td><td>Returnerer <code dir=\"auto\">boolean</code></td>"
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
          ...
          "set:html": "<tr><td><code dir=\"auto\">session.init({ path, body })</code></td><td>Analyser appen og lag <code dir=\"auto\">AGENTS.md</code></td><td>Returnerer <code dir=\"auto\">boolean</code></td></tr><tr><td><code dir=\"auto\">session.abort({ path })</code></td><td>Avbryt en løpesession</td><td>Returnerer <code dir=\"auto\">boolean</code></td></tr>"
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
          ...
          "set:html": "<td><code dir=\"auto\">session.summarize({ path, body })</code></td><td>Oppsummer sessionen</td><td>Returnerer <code dir=\"auto\">boolean</code></td>"
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
          ...
          children: [createVNode(_components.td, {
            ...
            }), " med AI svar. Understøtter ", createVNode(Fragment$1, {
              "set:html": "<code dir=\"auto\">body.outputFormat</code> for <a href=\"#struktureret-output\">struktureret output</a>"
            })]
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
...
const file = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/da/sdk.mdx";
...
Content.moduleId = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/da/sdk.mdx";
