...
function getHeadings() {
  return [{
    ...
    "depth": 2,
    "slug": "output-strutturato",
    "text": "Output Strutturato"
  }, {
    "depth": 3,
    "slug": "uso-base",
    "text": "Uso Base"
    ...
    "depth": 3,
    "slug": "tipi-di-formato-output",
    "text": "Tipi di Formato Output"
  }, {
    "depth": 3,
    "slug": "formato-schema-json",
    "text": "Formato Schema JSON"
  }, {
    "depth": 3,
    "slug": "gestione-errori",
    "text": "Gestione Errori"
  }, {
    "depth": 3,
    "slug": "best-practices",
    "text": "Best Practices"
    ...
    children: [createVNode(Fragment$1, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          ...
          "set:html": "<td><code dir=\"auto\">session.delete({ path })</code></td><td>Elimina una sessione</td><td>Returns <code dir=\"auto\">boolean</code></td>"
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
          ...
          "set:html": "<tr><td><code dir=\"auto\">session.init({ path, body })</code></td><td>Analizza app e crea <code dir=\"auto\">AGENTS.md</code></td><td>Returns <code dir=\"auto\">boolean</code></td></tr><tr><td><code dir=\"auto\">session.abort({ path })</code></td><td>Interrompe una sessione in corso</td><td>Returns <code dir=\"auto\">boolean</code></td></tr>"
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
          ...
          "set:html": "<td><code dir=\"auto\">session.summarize({ path, body })</code></td><td>Riassume la sessione</td><td>Returns <code dir=\"auto\">boolean</code></td>"
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
          ...
          children: [createVNode(_components.td, {
            ...
            }), " returns UserMessage (solo contesto). Di default ritorna ", createVNode("a", {
              href: typesUrl,
              "set:html": "<code>AssistantMessage</code>"
            }), " con risposta AI. Supporta ", createVNode(Fragment$1, {
              "set:html": "<code dir=\"auto\">body.outputFormat</code> per <a href=\"#output-strutturato\">output strutturato</a>"
            })]
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
          ...
          "set:html": "<td><code dir=\"auto\">postSessionByIdPermissionsByPermissionId({ path, body })</code></td><td>Risponde a una richiesta permessi</td><td>Returns <code dir=\"auto\">boolean</code></td>"
        })]
      })]
    }), "\n", createVNode(Fragment$1, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          ...
          "set:html": "<td><code dir=\"auto\">file.read({ query })</code></td><td>Legge un file</td><td><code dir=\"auto\">{ type: \"raw\" | \"patch\", content: string }</code></td>"
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
...
const file = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/it/sdk.mdx";
...
Content.moduleId = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/it/sdk.mdx";
