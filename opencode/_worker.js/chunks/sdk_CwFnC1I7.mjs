...
function getHeadings() {
  return [{
    ...
    "depth": 2,
    "slug": "strukturert-utdata",
    "text": "Strukturert Utdata"
  }, {
    "depth": 3,
    "slug": "grunnleggende-bruk",
    "text": "Grunnleggende bruk"
  }, {
    "depth": 3,
    "slug": "utdataformattyper",
    "text": "Utdataformattyper"
  }, {
    "depth": 3,
    "slug": "json-skjemaformat",
    "text": "JSON Skjemaformat"
  }, {
    "depth": 3,
    "slug": "feilhåndtering",
    "text": "Feilhåndtering"
    ...
    children: [createVNode(Fragment$1, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          ...
          "set:html": "<td><code dir=\"auto\">session.delete({ path })</code></td><td>Slett økt</td><td>Returnerer <code dir=\"auto\">boolean</code></td>"
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
          ...
          "set:html": "<tr><td><code dir=\"auto\">session.init({ path, body })</code></td><td>Analyser appen og lag <code dir=\"auto\">AGENTS.md</code></td><td>Returnerer <code dir=\"auto\">boolean</code></td></tr><tr><td><code dir=\"auto\">session.abort({ path })</code></td><td>Avbryt en kjørende økt</td><td>Returnerer <code dir=\"auto\">boolean</code></td></tr>"
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
          ...
          "set:html": "<td><code dir=\"auto\">session.summarize({ path, body })</code></td><td>Oppsummer økten</td><td>Returnerer <code dir=\"auto\">boolean</code></td>"
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
          ...
          children: [createVNode(_components.td, {
            ...
            }), " returnerer UserMessage (kun kontekst). Standard returnerer ", createVNode("a", {
              href: typesUrl,
              "set:html": "<code>AssistantMessage</code>"
            }), " med AI svar. Støtter ", createVNode(Fragment$1, {
              "set:html": "<code dir=\"auto\">body.outputFormat</code> for <a href=\"#strukturert-utdata\">strukturert utdata</a>"
            })]
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            ...
            children: "Send kommando til økt"
          }), createVNode(_components.td, {
            children: ["Returnerer ", createVNode(_components.code, {
              dir: "auto",
              children: "{ info: "
          ...
          children: [createVNode(_components.td, {
            ...
            children: "Gjenopprett reverserte meldinger"
          }), createVNode(_components.td, {
            children: ["Returnerer ", createVNode("a", {
              href: typesUrl,
              "set:html": "<code>Session</code>"
          ...
          "set:html": "<td><code dir=\"auto\">postSessionByIdPermissionsByPermissionId({ path, body })</code></td><td>Svar på en tillatelsesforespørsel</td><td>Returnerer <code dir=\"auto\">boolean</code></td>"
        })]
      })]
    }), "\n", createVNode(Fragment$1, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          ...
          "set:html": "<td><code dir=\"auto\">file.read({ query })</code></td><td>Les en fil</td><td><code dir=\"auto\">{ type: \"raw\" | \"patch\", content: string }</code></td>"
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
...
const url = "src/content/docs/nb/sdk.mdx";
const file = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/nb/sdk.mdx";
...
Content.moduleId = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/nb/sdk.mdx";
