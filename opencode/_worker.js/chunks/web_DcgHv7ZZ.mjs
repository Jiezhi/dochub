...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(Fragment$1, {
      "set:html": "<p>OpenCode 可以作為 Web 應用程式在瀏覽器中執行，無需終端機即可獲得同樣強大的 AI 編碼體驗。</p>\n"
      ...
      "set:html": "<h3 id=\"伺服器狀態\"><a href=\"#伺服器狀態\">伺服器狀態</a></h3>\n<p>點擊「See Servers」可以查看已連線的伺服器及其狀態。</p>\n"
    }), createVNode(_components.p, {
      children: createVNode(_component0, {
...
const file = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/zh-tw/web.mdx";
...
Content.moduleId = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/zh-tw/web.mdx";
