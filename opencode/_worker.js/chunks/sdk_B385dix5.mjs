    ...
    children: [createVNode(Fragment$1, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          ...
          "set:html": "<td><code dir=\"auto\">session.delete({ path })</code></td><td>删除会话</td><td>返回 <code dir=\"auto\">boolean</code></td>"
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
          ...
          "set:html": "<tr><td><code dir=\"auto\">session.init({ path, body })</code></td><td>分析应用并创建 <code dir=\"auto\">AGENTS.md</code></td><td>返回 <code dir=\"auto\">boolean</code></td></tr><tr><td><code dir=\"auto\">session.abort({ path })</code></td><td>中止正在运行的会话</td><td>返回 <code dir=\"auto\">boolean</code></td></tr>"
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
          ...
          "set:html": "<td><code dir=\"auto\">session.summarize({ path, body })</code></td><td>总结会话</td><td>返回 <code dir=\"auto\">boolean</code></td>"
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
          ...
          children: [createVNode(_components.td, {
            ...
            }), " 返回 UserMessage（仅注入上下文）。默认返回带有 AI 响应的 ", createVNode("a", {
              href: typesUrl,
              "set:html": "<code>AssistantMessage</code>"
            }), "。支持通过 ", createVNode(Fragment$1, {
              "set:html": "<code dir=\"auto\">body.outputFormat</code> 使用<a href=\"#%E7%BB%93%E6%9E%84%E5%8C%96%E8%BE%93%E5%87%BA\">结构化输出</a>"
            })]
          })]
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
          ...
          "set:html": "<td><code dir=\"auto\">postSessionByIdPermissionsByPermissionId({ path, body })</code></td><td>响应权限请求</td><td>返回 <code dir=\"auto\">boolean</code></td>"
        })]
      })]
    }), "\n", createVNode(Fragment$1, {
      ...
      children: [createVNode(_components.thead, {
        ...
        children: [createVNode(_components.tr, {
          ...
          "set:html": "<td><code dir=\"auto\">file.read({ query })</code></td><td>读取文件</td><td><code dir=\"auto\">{ type: \"raw\" | \"patch\", content: string }</code></td>"
        }), createVNode(_components.tr, {
          children: [createVNode(_components.td, {
            children: createVNode(_components.code, {
              dir: "auto",
...
const file = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/zh-cn/sdk.mdx";
...
Content.moduleId = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/zh-cn/sdk.mdx";
