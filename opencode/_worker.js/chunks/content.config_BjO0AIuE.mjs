...
import { p as pLimit, C as CONTENT_LAYER_TYPE, d as defineCollection } from './_astro_content_Bn-ZmsD_.mjs';
import path, { relative as relative$1 } from 'node:path';
import { fileURLToPath as fileURLToPath$1, pathToFileURL } from 'node:url';
import { ai as commonjsGlobal, aj as getDefaultExportFromCjs, v as bold, a8 as green } from './astro/server_D-7CwiXF.mjs';
import './../xxhash.1y1qkds.wasm';
import { s as slash } from './path_CEGCiB5i.mjs';
import require$$0, { sep, basename, dirname, resolve, normalize, relative, posix, isAbsolute } from 'path';
import './_astro_assets_D8SVuEtc.mjs';
...
import { statSync, stat, realpathSync, realpath, readdirSync, readdir } from 'fs';
import { fileURLToPath } from 'url';
import { createRequire } from 'module';
import { b as getCollectionPathFromRoot, i as i18nSchema } from './translations_CDEHKrA8.mjs';
import { d as docsSchema } from './_id__EZaS948T.mjs';
...
function requireCommonAncestorPath () {
	...
	const {parse, sep, normalize: norm} = require$$0;
