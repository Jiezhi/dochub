...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(Fragment$1, {
      "set:html": "<p>OpenCode 可以作为 Web 应用在浏览器中运行，无需终端即可获得同样强大的 AI 编码体验。</p>\n"
      ...
      "set:html": "<h3 id=\"服务器状态\"><a href=\"#服务器状态\">服务器状态</a></h3>\n<p>点击”See Servers”可以查看已连接的服务器及其状态。</p>\n"
    }), createVNode(_components.p, {
      children: createVNode(_component0, {
...
const file = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/zh-cn/web.mdx";
...
Content.moduleId = "/home/runner/work/dochub/dochub/_src/packages/web/src/content/docs/zh-cn/web.mdx";
